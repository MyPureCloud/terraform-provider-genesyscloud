...
import (
	...
	workitemDateBasedRule "terraform-provider-genesyscloud/genesyscloud/task_management_worktypes_flows_datebased_rule"
	workitemOnAttributeChangeRule "terraform-provider-genesyscloud/genesyscloud/task_management_worktypes_flows_onattributechange_rule"
	workitemOnCreateRule "terraform-provider-genesyscloud/genesyscloud/task_management_worktypes_flows_oncreate_rule"
