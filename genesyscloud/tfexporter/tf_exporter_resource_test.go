...
func SetRegistrar_test() (map[string]*schema.Resource,map[string]*schema.Resource) {
	...
	providerResources["genesyscloud_externalcontacts_contact"] = gcloud.ResourceExternalContact()
...
func SetExporter_test() {
	...
	RegisterExporter("genesyscloud_externalcontacts_contact", gcloud.ExternalContactExporter())
	...
	RegisterExporter("genesyscloud_script", gcloud.ScriptExporter())
	...
	RegisterExporter("genesyscloud_telephony_providers_edges_site", gcloud.SiteExporter())
