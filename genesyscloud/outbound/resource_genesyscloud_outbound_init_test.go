...
import (
	...
	"terraform-provider-genesyscloud/genesyscloud/outbound_campaignrule"
...
func (r *registerTestInstance) registerTestResources() {
	...
	providerResources["genesyscloud_outbound_campaignrule"] = outbound_campaignrule.ResourceOutboundCampaignRule()
...
func (r *registerTestInstance) registerTestDataSources() {
	...
	providerDataSources["genesyscloud_outbound_campaignrule"] = outbound_campaignrule.DataSourceOutboundCampaignrule()
	...
	providerDataSources["genesyscloud_outbound_sequence"] = outbound_sequence.DataSourceOutboundSequence()
