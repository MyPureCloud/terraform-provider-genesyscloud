...
type createBusinessRulesSchemaFunc func(ctx context.Context, p *businessRulesSchemaProxy, schema *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error)
...
type updateBusinessRulesSchemaFunc func(ctx context.Context, p *businessRulesSchemaProxy, id string, schema *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error)
...
func (p *businessRulesSchemaProxy) createBusinessRulesSchema(ctx context.Context, schema *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error) {
...
func (p *businessRulesSchemaProxy) updateBusinessRulesSchema(ctx context.Context, id string, schemaUpdate *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error) {
...
func createBusinessRulesSchemaFn(ctx context.Context, p *businessRulesSchemaProxy, schema *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error) {
	log.Printf("Creating business rules schema: %s", *schema.Name)
	request := platformclientv2.Businessrulesschemacreaterequest{}
	createdSchema, resp, err := p.businessRulesApi.PostBusinessrulesSchemas(request)
...
func updateBusinessRulesSchemaFn(ctx context.Context, p *businessRulesSchemaProxy, id string, schemaUpdate *platformclientv2.Businessrulesdataschema) (*platformclientv2.Businessrulesdataschema, *platformclientv2.APIResponse, error) {
	request := platformclientv2.Businessrulesschemaupdaterequest{
		Version: schemaUpdate.Version,
		Enabled: schemaUpdate.Enabled,
	}
	schema, resp, err := p.businessRulesApi.PutBusinessrulesSchema(id, request)
	if err != nil {
