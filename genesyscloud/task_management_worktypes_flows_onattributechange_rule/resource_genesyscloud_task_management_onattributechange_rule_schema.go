...
2.  The resource schema definitions for the task_management_worktypes_flows_onattributechange_rule resource.
3.  The datasource schema definitions for the task_management_worktypes_flows_onattributechange_rule datasource.
4.  The resource exporter configuration for the task_management_worktypes_flows_onattributechange_rule exporter.
*/
const ResourceType = "genesyscloud_task_management_worktypes_flows_onattributechange_rule"
...
// ResourceTaskManagementOnAttributeChangeRule registers the genesyscloud_task_management_worktypes_flows_onattributechange_rule resource with Terraform
...
// TaskManagementOnAttributeChangeRuleExporter returns the resourceExporter object used to hold the genesyscloud_task_management_onattributechange_rule exporter's config
...
// DataSourceTaskManagementOnAttributeChangeRule registers the genesyscloud_task_management_onattributechange_rule data source
