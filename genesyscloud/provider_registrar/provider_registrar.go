...
var providerResources = make(map[string]*schema.Resource)
var providerDataSources = make(map[string]*schema.Resource)
var resourceExporters = make(map[string]*resourceExporter.ResourceExporter)
...
func GetAllResources() (map[string]*schema.Resource, map[string]*schema.Resource, map[string]*resourceExporter.ResourceExporter) {
	if providerResources == nil || len(providerResources) == 0 {
		registerResources()
	}
	return providerResources, providerDataSources, resourceExporters
}
