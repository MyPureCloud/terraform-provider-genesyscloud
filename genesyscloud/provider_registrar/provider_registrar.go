...
import (
	...
	greetingGroup "github.com/mypurecloud/terraform-provider-genesyscloud/genesyscloud/greeting_group"
...
func registerResources() {
	...
	greetingGroup.SetRegistrar(regInstance)                                //Registering greeting group
