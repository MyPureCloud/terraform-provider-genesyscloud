...
/*
resource_genesyscloud_webdeployments_configuration_schema.go should hold four types of functions within it:

1.  The registration code that registers the Datasource, Resource and Exporter for the package.
2.  The resource schema definitions for the webdeployments_configuration resource.
3.  The datasource schema definitions for the webdeployments_configuration datasource.
4.  The resource exporter configuration for the webdeployments_configuration configuration.
*/
