...
/*
   The genesyscloud_integration_action_draft_init_test.go file is used to initialize the data sources and resources
   used in testing the integration action draft resource.
...
func (r *registerTestInstance) registerTestResources() {
	...
	providerResources[ResourceType] = ResourceIntegrationActionDraft()
...
func (r *registerTestInstance) registerTestDataSources() {
	...
	providerDataSources[ResourceType] = DataSourceIntegrationActionDraft()
