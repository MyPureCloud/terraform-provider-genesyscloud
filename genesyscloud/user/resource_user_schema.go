...
func ResourceUser() *schema.Resource {
	...
	return &schema.Resource{
		...
		CreateContext: gcloud.CreateWithPooledClient(createUser),
		ReadContext:   gcloud.ReadWithPooledClient(readUser),
		UpdateContext: gcloud.UpdateWithPooledClient(updateUser),
		DeleteContext: gcloud.DeleteWithPooledClient(deleteUser),
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"date_hire": {
							...
							Type:             schema.TypeString,
							Optional:         true,
							ValidateDiagFunc: gcloud.ValidateDate,
						},
					},
				},
			},
...
func UserExporter() *resourceExporter.ResourceExporter {
	return &resourceExporter.ResourceExporter{
		GetResourcesFunc: gcloud.GetAllWithPooledClient(getAllUsers),
...
func DataSourceUser() *schema.Resource {
	return &schema.Resource{
		...
		ReadContext: gcloud.ReadWithPooledClient(dataSourceUserRead),
		Schema: map[string]*schema.Schema{
			"email": {
