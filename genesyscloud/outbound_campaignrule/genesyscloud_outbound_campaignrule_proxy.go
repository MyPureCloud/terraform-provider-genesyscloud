...
type createOutboundCampaignruleFunc func(ctx context.Context, p *outboundCampaignruleProxy, campaignRule *platformclientv2.Campaignrule) (*platformclientv2.Campaignrule, error)
type getAllOutboundCampaignruleFunc func(ctx context.Context, p *outboundCampaignruleProxy) (*[]platformclientv2.Campaignrule, error)
type getOutboundCampaignruleIdByNameFunc func(ctx context.Context, p *outboundCampaignruleProxy, name string) (id string, retryable bool, err error)
type getOutboundCampaignruleByIdFunc func(ctx context.Context, p *outboundCampaignruleProxy, id string) (campaignRule *platformclientv2.Campaignrule, responseCode int, err error)
type updateOutboundCampaignruleFunc func(ctx context.Context, p *outboundCampaignruleProxy, id string, campaignRule *platformclientv2.Campaignrule) (*platformclientv2.Campaignrule, error)
...
func (p *outboundCampaignruleProxy) createOutboundCampaignrule(ctx context.Context, outboundCampaignrule *platformclientv2.Campaignrule) (*platformclientv2.Campaignrule, error) {
...
func (p *outboundCampaignruleProxy) getAllOutboundCampaignrule(ctx context.Context) (*[]platformclientv2.Campaignrule, error) {
...
func (p *outboundCampaignruleProxy) getOutboundCampaignruleIdByName(ctx context.Context, name string) (id string, retryable bool, err error) {
...
func (p *outboundCampaignruleProxy) getOutboundCampaignruleById(ctx context.Context, id string) (outboundCampaignrule *platformclientv2.Campaignrule, statusCode int, err error) {
...
func (p *outboundCampaignruleProxy) updateOutboundCampaignrule(ctx context.Context, id string, outboundCampaignrule *platformclientv2.Campaignrule) (*platformclientv2.Campaignrule, error) {
...
func getAllOutboundCampaignruleFn(ctx context.Context, p *outboundCampaignruleProxy) (*[]platformclientv2.Campaignrule, error) {
	var allCampaignRules []platformclientv2.Campaignrule
	const pageSize = 100

	campaignRules, _, err := p.outboundApi.GetOutboundCampaignrules(pageSize, 1, true, "", "", "", "")
	if err != nil {
		return nil, fmt.Errorf("Failed to get campaign rules: %v", err)
	}

	if campaignRules.Entities == nil || len(*campaignRules.Entities) == 0 {
		return &allCampaignRules, nil
	}
	...
	for pageNum := 2; pageNum <= *campaignRules.PageCount; pageNum++ {
		campaignRules, _, err := p.outboundApi.GetOutboundCampaignrules(pageSize, pageNum, true, "", "", "", "")
		if err != nil {
			return nil, fmt.Errorf("Failed to get campaign rules: %v", err)
		}
...
func getOutboundCampaignruleIdByNameFn(ctx context.Context, p *outboundCampaignruleProxy, name string) (id string, retryable bool, err error) {
	campaignRules, _, err := p.outboundApi.GetOutboundCampaignrules(100, 1, true, "", name, "", "")
	if err != nil {
		return "", false, err
	}

	if campaignRules.Entities == nil || len(*campaignRules.Entities) == 0 {
		return "", true, fmt.Errorf("No outbound campaignrule with name %s", name)
	}

	for _, campaignRule := range *campaignRules.Entities {
		if *campaignRule.Name == name {
			log.Printf("Retrieved the outbound capaign rule id %s by name %s", *campaignRule.Id, name)
			return *campaignRule.Id, false, nil
		}
	}

	return "", true, fmt.Errorf("Unable to find outbound campaign rule with name %s", name)
}

// getOutboundCampaignruleByIdFn is an implementation of the function to get a Genesys Cloud outbound campaignrule by Id
func getOutboundCampaignruleByIdFn(ctx context.Context, p *outboundCampaignruleProxy, id string) (outboundCampaignrule *platformclientv2.Campaignrule, statusCode int, err error) {
	rule, resp, err := p.outboundApi.GetOutboundCampaignrule(id)
	if err != nil {
		return nil, resp.StatusCode, fmt.Errorf("Failed to retrieve campaign rule by id %s: %s", id, err)
	}
...
func updateOutboundCampaignruleFn(ctx context.Context, p *outboundCampaignruleProxy, id string, outboundCampaignrule *platformclientv2.Campaignrule) (*platformclientv2.Campaignrule, error) {
	rule, _, err := getOutboundCampaignruleByIdFn(ctx, p, id)
	if err != nil {
		return nil, fmt.Errorf("Failed to campaign rule by id %s: %s", id, err)
	}

	outboundCampaignrule.Version = rule.Version
	campaignRule, _, err := p.outboundApi.PutOutboundCampaignrule(id, *outboundCampaignrule)
	if err != nil {
		return nil, fmt.Errorf("Failed to update campaign rule: %s", err)
	}
