...
func SetRegistrar(l registrar.Registrar) {
	l.RegisterDataSource("genesyscloud_telephony_providers_extension_pool", DataSourceExtensionPool())
	l.RegisterResource("genesyscloud_telephony_providers_extension_pool", ResourceTelephonyExtensionPool())
	l.RegisterExporter("genesyscloud_telephony_providers_extension_pool", TelephonyExtensionPoolExporter())
}
