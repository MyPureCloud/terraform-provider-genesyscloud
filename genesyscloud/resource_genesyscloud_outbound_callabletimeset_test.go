...
func TestAccResourceOutboundCallabletimeset(t *testing.T) {
	var (
		...
		//	timeZone2,
		//	generateTimeSlotsBlock("8:15:15", "20:30:45", "2"),
		//	generateTimeSlotsBlock("00:00:00", "12:00:00", "4"),
		//)
	)
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_zone_id", timeZone1),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.0.start_time", "09:00:00"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.0.stop_time", "21:30:30"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.0.day", "1"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.1.start_time", "10:30:45"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.1.stop_time", "23:00:15"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.1.time_slots.1.day", "7"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_zone_id", timeZone2),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.0.start_time", "8:15:15"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.0.stop_time", "20:30:45"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.0.day", "2"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.1.start_time", "00:00:00"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.1.stop_time", "12:00:00"),
					resource.TestCheckResourceAttr("genesyscloud_outbound_callabletimeset."+resourceId, "callable_times.0.time_slots.1.day", "4"),
				),
			},
			{
				// Read
