...
type createResponsemanagementResponseFunc func(ctx context.Context, p *responsemanagementResponseProxy, response *platformclientv2.Response) (responseManagementResponse *platformclientv2.Response, statusCode int, err error)
type getAllResponsemanagementResponseFunc func(ctx context.Context, p *responsemanagementResponseProxy, libraryId string) (*[]platformclientv2.Response, error)
type getResponsemanagementResponseIdByNameFunc func(ctx context.Context, p *responsemanagementResponseProxy, name string, libraryId string) (id string, retryable bool, err error)
type getResponsemanagementResponseByIdFunc func(ctx context.Context, p *responsemanagementResponseProxy, id string) (response *platformclientv2.Response, responseCode int, err error)
type updateResponsemanagementResponseFunc func(ctx context.Context, p *responsemanagementResponseProxy, id string, response *platformclientv2.Response) (*platformclientv2.Response, error)
type deleteResponsemanagementResponseFunc func(ctx context.Context, p *responsemanagementResponseProxy, id string) (responseCode int, err error)
...
func (p *responsemanagementResponseProxy) createResponsemanagementResponse(ctx context.Context, responsemanagementResponse *platformclientv2.Response) (response *platformclientv2.Response, statusCode int, err error) {
...
func (p *responsemanagementResponseProxy) getAllResponsemanagementResponse(ctx context.Context) (*[]platformclientv2.Response, error) {
...
func (p *responsemanagementResponseProxy) getResponsemanagementResponseIdByName(ctx context.Context, name string, libraryId string) (id string, retryable bool, err error) {
...
func (p *responsemanagementResponseProxy) getResponsemanagementResponseById(ctx context.Context, id string) (responsemanagementResponse *platformclientv2.Response, statusCode int, err error) {
...
func (p *responsemanagementResponseProxy) updateResponsemanagementResponse(ctx context.Context, id string, responsemanagementResponse *platformclientv2.Response) (*platformclientv2.Response, error) {
...
func (p *responsemanagementResponseProxy) deleteResponsemanagementResponse(ctx context.Context, id string) (statusCode int, err error) {
...
func createResponsemanagementResponseFn(ctx context.Context, p *responsemanagementResponseProxy, responsemanagementResponse *platformclientv2.Response) (*platformclientv2.Response, int, error) {
...
func getAllResponsemanagementResponseFn(ctx context.Context, p *responsemanagementResponseProxy, libraryId string) (*[]platformclientv2.Response, error) {
	var allResponseManagementResponses []platformclientv2.Response
	const pageSize = 100

	if libraryId != "" {
		responses, _, getErr := p.responseManagementApi.GetResponsemanagementResponses(libraryId, 1, pageSize, "")
		if getErr != nil {
			return nil, fmt.Errorf("Error requesting page of Responsemanagement Response: %s", getErr)
		}

		if responses.Entities == nil || len(*responses.Entities) == 0 {
			return &allResponseManagementResponses, nil
		}
	...
	libraries, _, getErr := p.responseManagementApi.GetResponsemanagementLibraries(1, pageSize, "", "")
	if getErr != nil {
		return nil, fmt.Errorf("Error requesting page of Responsemanagement library: %s", getErr)
	}
	...
	for _, library := range *libraries.Entities {
		for pageNum := 1; ; pageNum++ {
			responses, _, getErr := p.responseManagementApi.GetResponsemanagementResponses(*library.Id, pageNum, pageSize, "")
			if getErr != nil {
				return nil, fmt.Errorf("Error requesting page of Responsemanagement Response: %s", getErr)
			}
	...
	for pageNum := 2; pageNum <= *libraries.PageCount; pageNum++ {
		libraries, _, getErr := p.responseManagementApi.GetResponsemanagementLibraries(pageNum, pageSize, "", "")
...
func getResponsemanagementResponseIdByNameFn(ctx context.Context, p *responsemanagementResponseProxy, name string, libraryId string) (id string, retryable bool, err error) {
	responses, err := getAllResponsemanagementResponseFn(ctx, p, libraryId)
	if err != nil {
		return "", false, fmt.Errorf("Error searching response management responses %s: %s", name, err)
	}
	...
	return "", true, fmt.Errorf("Unable to find response management response with name %s", name)
}
...
func getResponsemanagementResponseByIdFn(ctx context.Context, p *responsemanagementResponseProxy, id string) (responsemanagementResponse *platformclientv2.Response, statusCode int, err error) {
	mamangementResponse, resp, err := p.responseManagementApi.GetResponsemanagementResponse(id, "")
	if err != nil {
		return nil, resp.StatusCode, err
	}
	return mamangementResponse, resp.StatusCode, nil
}
...
func updateResponsemanagementResponseFn(ctx context.Context, p *responsemanagementResponseProxy, id string, response *platformclientv2.Response) (*platformclientv2.Response, error) {
	responsemanagementResponse, _, err := p.responseManagementApi.GetResponsemanagementResponse(id, "")
	if err != nil {
		return nil, err
	}

	response.Version = responsemanagementResponse.Version
	responsemanagementResponse, _, updateErr := p.responseManagementApi.PutResponsemanagementResponse(id, *response, "")
	if updateErr != nil {
		return nil, updateErr
	}

	return responsemanagementResponse, nil
}
...
func deleteResponsemanagementResponseFn(ctx context.Context, p *responsemanagementResponseProxy, id string) (statusCode int, err error) {
