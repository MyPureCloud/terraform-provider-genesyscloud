...
func TestAccExporterCustomMemberGroup(t *testing.T) {
	...
	for _, testResult := range testResults {
		...
		skillGroupSanitizedResourceMap[testResult.MemberGroupID] = &ResourceMeta{ResourceName: testResult.Name, LabelName: testResult.GroupName}
...
func TestRuleSetPropertyGroup(t *testing.T) {
	...
	for _, testResult := range testResults {
		...
		skillSanitizedResourceMap[uuid] = &ResourceMeta{ResourceName: testResult.Name, LabelName: testResult.SkillName}
