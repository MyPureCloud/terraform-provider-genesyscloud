...
const resource_name = "genesyscloud_architect_user_prompt"

// SetRegistrar registers all of the resources, datasources and exporters in the package
func SetRegistrar(regInstance registrar.Registrar) {
	regInstance.RegisterResource(resource_name, ResourceArchitectUserPrompt())
	regInstance.RegisterDataSource(resource_name, DataSourceUserPrompt())
	regInstance.RegisterExporter(resource_name, ArchitectUserPromptExporter())
}
