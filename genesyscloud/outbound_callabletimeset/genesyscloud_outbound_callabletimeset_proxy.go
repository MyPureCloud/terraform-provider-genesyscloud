...
func (p *outboundCallableTimesetProxy) getOutboundCallabletimesetById(ctx context.Context, timesetId string) (timeset *platformclientv2.Callabletimeset, statusCode int, err error) {
...
func (p *outboundCallableTimesetProxy) getOutboundCallabletimesetByName(ctx context.Context, name string) (timesetId string, retryable bool, err error) {
...
func (p *outboundCallableTimesetProxy) deleteOutboundCallabletimeset(ctx context.Context, timesetId string) (statusCode int, err error) {
...
func getOutboundCallabletimesetByIdFn(ctx context.Context, p *outboundCallableTimesetProxy, timesetId string) (timeset *platformclientv2.Callabletimeset, statusCode int, err error) {
	...
	if err != nil {
		...
		return nil, 0, fmt.Errorf("Failed to retrieve timeset by id %s: %s", timesetId, err)
	}
...
func deleteOutboundCallabletimesetFn(ctx context.Context, p *outboundCallableTimesetProxy, timesetId string) (statusCode int, err error) {
	resp, err := p.outboundApi.DeleteOutboundCallabletimeset(timesetId)
	if err != nil {
		return resp.StatusCode, fmt.Errorf("Failed to delete timeset: %s", err)
	}
