...
func (r *registerTestInstance) registerTestResources() {
	...
	providerResources[ResourceType] = ResourceEmployeeperformanceExternalmetricsDefinition()
}
...
func (r *registerTestInstance) registerTestDataSources() {
	...
	providerDataSources[ResourceType] = DataSourceEmployeeperformanceExternalmetricsDefinition()
}
