...
func (r *registerTestInstance) registerTestResources() {
	...
	providerResources[resourceName] = ResourceTaskManagementOnAttributeChangeRule()
...
func (r *registerTestInstance) registerTestDataSources() {
	...
	providerDataSources[resourceName] = DataSourceTaskManagementOnAttributeChangeRule()
}
...
func TestMain(m *testing.M) {
	// Run setup function before starting the test suite for the task_management_onattributechange_rule package
	initTestResources()

	// Run the test suite for the task_management_onattributechange_rule package
	m.Run()
}
