...
- `log_stack_traces` (Boolean) If set to true the provider will log stack traces to a file instead of crashing, where possible. 
...
"Root object was present, but now absent." Can be set with the GENESYSCLOUD_LOG_STACK_TRACES environment variable.
