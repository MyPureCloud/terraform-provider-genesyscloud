...
- `push_integrations` (Block List) The push integration objects associated with the deployment (see [below for nested schema](#nestedblock--push_integrations))
- `status` (String) The current status of the deployment. Valid values: Pending, Active, Inactive, Error, Deleting.
- `supported_content_id` (String) The supported content profile ID associated with this deployment

### Read-Only

- `id` (String) The ID of this resource.
- `snippet` (String) Javascript snippet used to load the deployment. This field is read-only and generated by Genesys Cloud.
...
<a id="nestedblock--push_integrations"></a>
### Nested Schema for `push_integrations`

Required:

- `id` (String) The mobile push integration ID
- `provider` (String) The integration provider. Valid values: APNS (Apple Push Notification Service), FCM (Firebase Cloud Messaging)
