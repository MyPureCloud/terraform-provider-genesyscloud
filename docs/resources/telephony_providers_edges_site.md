...
- `caller_id` (String) The caller ID value for the site. The callerID is a valid E.164 formatted phone number
...
- `media_regions` (List of String) The ordered list of AWS regions through which media can stream
